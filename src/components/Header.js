  ...
  return (
    <div className="header1">
      ...
      <div className="address">
        <p>
          <FontAwesomeIcon color="#86003e" size="x" icon={faLocationDot} /> :
          189 Ashish Charkop Mumbai-400067
        </p>
        <p>
          {" "}
          <FontAwesomeIcon color="#86003e" size="x" icon={faPhone} /> :
          02228691908/1503
        </p>
        <p>
          <FontAwesomeIcon color="#86003e" size="x" icon={faMailForward} /> :
          mbsmmandal@gmail.com
        </p>
      </div>
    </div>
  );
